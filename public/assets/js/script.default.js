$(document).ready(function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'https://www.googleapis.com/youtube/v3/playlistItems?part=id&playlistId=PLIluMM1HNoRo8G1g8XwMkBUg6iaCXCqag&key=AIzaSyBAMiaNLinGMif1Lz9KeJpxPXRzJi30y9M',
        success: function (e) {
            console.log(e);
