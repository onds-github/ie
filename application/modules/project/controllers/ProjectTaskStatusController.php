...
class Project_ProjectTaskStatusController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->view->id_module = 8;
        $this->view->title_page = 'Status da Tarefa';
        $this->view->description_page = 'Monitoramento por status do tarefas';

        $this->view->headScript()
                ->appendFile('/public/modules/project/script.project-task-status.js');
    ...
    public function ajaxAction() {
        ...
        Zend_Loader::loadClass('ProjectTaskStatus');
        $model = new ProjectTaskStatus();
