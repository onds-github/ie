...
class Project_ProjectTaskController extends Zend_Controller_Action {

    protected $_table = "on_project_task";
    protected $_primaryKey = "project_task_id";
    ...
    public function indexAction() {
        ...
        $this->view->description_page = 'Gerencimento de tarefas';

        $this->view->headScript()
                ->appendFile('/public/modules/project/script.project-task.js');
    ...
    public function ajaxAction() {
        ...
        curl_setopt($ch, CURLOPT_URL, APIURL . "/rest/v1/{$this->_table}?select=*");
