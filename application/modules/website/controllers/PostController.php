...
class Website_PostController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->view->title_page = 'Post';
        $this->view->description_page = 'Gerenciamento de post';
        
        $this->view->headScript()
                ->appendFile('/public/modules/website/script.post.js');
    }
